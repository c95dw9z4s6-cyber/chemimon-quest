/* Chemion Quest v__APP_VERSION__ service worker */
'use strict';
const CACHE_PREFIX = 'chemimon-quest-';
const SHELL_CACHE = `${CACHE_PREFIX}shell-v__APP_VERSION__`;
const RUNTIME_CACHE = `${CACHE_PREFIX}runtime-v__APP_VERSION__`;
const APP_SHELL = [
  './',
  './index.html',
